    ...
    <>
        <div className='navbar py-0 px-2 shadow-lg d-flex align-items-center'> 
          <div className="d-flex align-items-center gap-sm-2">
            {auth && (
              <div onClick={()=>setShow(true)} className="border py-sm-0 px-1 px-sm-2 rounded border-2">
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              <div>
                <Link to={'/information?tab=profile'} >
                  ...
                  <small  className='ms-1'>{Number(user.balance).toLocaleString('en-US')} MMK</small>
                </Link>
              </div>
            </div>
          )}
            ...
            <Offcanvas.Body className='w-100'>
              {navLinks.map((item,index)=>{
                  return  <div onClick={()=>{
                    navigate(item.link)
                    setShow(false)
                  }} key={index} className="  mb-3 d-flex align-items-center gap-3">
